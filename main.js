const token = 'NDg4NjI3NDA3MzM5OTEzMjE2.XMZM2g.4S_spWhw8yLvjcAS5G37WzBx2pQ'
...
const roblox = new bloxy({
  cookie: "_|WARNING:-DO-NOT-SHARE-THIS.--Sharing-this-will-allow-someone-to-log-in-as-you-and-to-steal-your-ROBUX-and-items.|_"
})
...
var config = {
    apiKey: "AIzaSyAkrkxV-lT0cfV-SU9rq9bYXCU296s_MDQ",
    authDomain: "aegiscorebot-fcc9b.firebaseapp.com",
    databaseURL: "https://aegiscorebot-fcc9b.firebaseio.com",
    projectId: "aegiscorebot-fcc9b",
    storageBucket: "aegiscorebot-fcc9b.appspot.com",
    messagingSenderId: "180142821180"
  };
...
aegisAutomation.on('message', async message => {
    ...
    if (args[1] === "add"){
      ...
      for (i = 0; i < userArray.length; i++){
        ...
        if (body.success === false){
          ...
          var { body } = await snekfetch.get(`https://aegiscorebot-fcc9b.firebaseio.com/${userID}.json`);
          var currentXP;
          ...
          if (!body){ // work on this
            ...
            var { body } = await snekfetch.get(`https://aegiscorebot-fcc9b.firebaseio.com/rankLock/${userID}.json`)
      ...
      for (i = 0; i < userArray.length; i++){
        ...
        if (body.success === false){
          ...
          while (whileLoopTest === 1){
            ...
            var { body } = await snekfetch.get(`https://aegiscorebot-fcc9b.firebaseio.com/rankLock/${userIDDD}.json`)
            var doesUserHaveProfile;
            if (body){
              doesUserHaveProfile = 1
            }else{
  ...
  if (message.content.startsWith(prefix + "view")){
    ...
    var { body } = await snekfetch.get(`https://aegiscorebot-fcc9b.firebaseio.com/warnings/${userID}.json`);
    var a = 0;
    if (!body){
      a = 0;
    }
    if (body){
      for (i = 0; i < 10000; i++){
      var { body } = await snekfetch.get(`https://aegiscorebot-fcc9b.firebaseio.com/warnings/${userIDRBLLX}/${i}.json`);
      if (!body){
        a = i + 1
    ...
    if (a > 0){
      var { body } = await snekfetch.get(`https://aegiscorebot-fcc9b.firebaseio.com/warnings/${userIDDD}.json`);
      for (i = 0; i < 10000; i++){
          var { body } = await snekfetch.get(`https://aegiscorebot-fcc9b.firebaseio.com/warnings/${userIDDD}/${i}.json`);
          if (!body){
            a = i + 1
            if (a < 0){ // if 0 warnings
              a = 0;
  ...
  if (message.content.startsWith(prefix + "warn")){
    ...
    var { body } = await snekfetch.get(`https://aegiscorebot-fcc9b.firebaseio.com/warnings/${userIDRBLLX}.json`);
  ...
  if (message.content.startsWith(prefix + "rankLock")){
    ...
    var { body } = await snekfetch.get(`https://aegiscorebot-fcc9b.firebaseio.com/rankLock/${rblxUserID}.json`)
    if (body){
